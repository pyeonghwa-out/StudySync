...
const FlashcardManager = ({ documentId }) => {
  ...
  console.log("DocumentDetailPage id:", documentId);
      ...
      return (
        <div className="flex flex-col items-center justify-center py-16 px-6">
          ...
          <button
            ...
            disabled={generating}
            className="group inline-flex items-center gap-2 px-6 h-12 bg-linear-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white shadow-emerald-500/25 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed disabled:active:scale-100"
          >
            {generating ? (
              <>
