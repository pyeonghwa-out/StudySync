            ...
            <form onSubmit={handleUpload} className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  required
                  className="w-full h-12 px-4 border-2 border-slate-200 rounded-xl bg-slate-50/50 transition-all duration-200 focus:outline-none focus:border-emerald-500 focus:bg-white focus:shadow"
