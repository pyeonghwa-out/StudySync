...
const QuizResultPage = () => {
              ...
              <div className="flex justify-between items-start mb-6">
                <div className="flex-1">
                  <div className= "inline-flex items-center gap-2 px-3 py-1 bg-slate-50 border border-slate-200 rounded-lg mb-3">
                    <span className=" border-slate-200 bg-slate-100 text-xs font-semibold text-slate-700">Question {index + 1}</span>
                  </div>
                  <h4 className="mt-4 text-2xl font-semibold text-slate-900 leading-relaxed">{result.question}</h4>
                </div>
                <div
  ...
  <div
    key={optIndex}
    className={`w-full rounded-xl border-2 px-6 py-4 transition-all duration-200
...
`}
      ...
      <div className="flex items-center gap-2">
        ...
        {isCorrectOption && (
          <div className="inline-flex items-center gap-2 rounded-lg border border-emerald-300 bg-emerald-100 px-3 py-1 text-sm font-semibold text-emerald-700">
        ...
        {isWrongAnswer && (
          <div className="inline-flex items-center gap-2 rounded-lg border border-rose-300 bg-rose-100 px-3 py-1 text-sm font-semibold text-rose-700">
